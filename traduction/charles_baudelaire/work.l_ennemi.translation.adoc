...
.Présentation des mots possibles pour §1D
[format="csv"]
[options="header"]
[frame="topbot", grid="none"]
|===
Français, Lojban, Traduction
reste/quantity  , klani   , [{fa}]#fa# x1 is a quantity quantified/measured/enumerated by x2 (quantifier) on scale x3 (si'o)
reste/remain    , stali   , [{fa}]#fa# remains/stays at/abides/lasts with [{fe}]#fe#
reste/fin       , fanmo   , [{fa}]#fa# x1 is an end/finish/termination of thing/process x2; [not necessarily implying completeness]
...
vermeil/rouge   , xunre   , [{fa}]#fa# is red/crimson/ruddy [color adjective]
|===
...
TIP: Il est possible de placer §1α directement dans [{fe}]#fe# en le remplaçant par go'i.

§1D doit être décomposé et transformé en proposition.

- §1D — «fruits vermeils» → lo rutma'u xunre grute ku
- §1D — «peu de fruits vermeils» → lo rutma'u xunre grute ku cu sotmei
- §1Dα 

Première tentative:

[{fa}]#lo lidysina ce carvi ku# [underline]#cu tolprali# [{fe}]#go'i# [{fi}]##
